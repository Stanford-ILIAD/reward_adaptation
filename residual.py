...
from residual_policy import ResidualMlpPolicy, resave_model_residual, load_residual_model
...
class RewardCurriculum(object):
    ...
    def __init__(self, model_dir, num_envs, experiment_name, timesteps, is_save, eval_save_period):
        if model_dir is not None:
          self.model = load_residual_model(PPO2, model_dir)  # loads pre-trained model
