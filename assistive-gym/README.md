# README for 'https://github.com/Healthcare-Robotics/assistive-gym' which is the environment we use for this experiment. We follow the same installation but modify some environments to form our homotopy classes.
...
## Training command
All the training commands are in curriculum.sh
